...
app.get('/api/appointments/:id', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
...
app.post('/api/appointments', asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
app.put('/api/appointments/:id', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
  const { name, phone, type, time, notes, date } = req.body;
...
app.delete('/api/appointments/:id', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
