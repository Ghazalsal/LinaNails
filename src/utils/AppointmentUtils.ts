...
export const createWhatsAppMessage = (clientName: string, date: Date, time: string, service: string, duration: number) => {
...
export const sendWhatsAppReminder = (phone: string, message: string) => {
